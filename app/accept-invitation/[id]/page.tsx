...
import { Loader2, Mail, Briefcase, CheckCircle2, XCircle } from "lucide-react";
...
function InvitationFlow({ invitationId }: { invitationId: string }) {
  ...
  async function handleCreateAccount(e: React.FormEvent) {
    ...
    try {
      ...
      // For agents, no role upgrade needed - they stay as AGENT with member role in organization
      ...
      <Card className="w-full max-w-md text-center">
        <CardContent className="pt-6 space-y-4">
          ...
          <p className="font-medium">
            Bienvenue dans {invitation?.organizationName} !
          </p>
